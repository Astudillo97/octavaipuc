...
-- -----------------------------------------------------
-- Table `OCTAVAIPUC`.`SEDE`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `OCTAVAIPUC`.`SEDE` (
  `IDSEDE` INT NOT NULL AUTO_INCREMENT,
  `SED_DETALLE` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`IDSEDE`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `OCTAVAIPUC`.`INFORMACION` (
  ...
  INDEX `fk_INFORMACION_SEDE1_idx` (`SED_IDSEDE` ASC),
  CONSTRAINT `fk_FECHAS_persona1`
    FOREIGN KEY (`PER_IDPERSONA`)
    REFERENCES `OCTAVAIPUC`.`persona` (`IDPERSONA`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_INFORMACION_SEDE1`
    FOREIGN KEY (`SED_IDSEDE`)
    REFERENCES `OCTAVAIPUC`.`SEDE` (`IDSEDE`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `OCTAVAIPUC`.`IMAGEN` (
  ...
  INDEX `fk_IMAGEN_persona1_idx` (`PER_IDPERSONA` ASC),
